...
:       
    ...
    bToDp_(constantProperties_, "bToDpRatio", 3),
...
//     diffWorkField.internalField() = s.internalField();
    ...
    forAll(list[diffusionRunTime_.timeIndex()], step)
    {
        diffWorkFieldInterFeildRef[list[diffusionRunTime_.timeIndex()][step]] 
      = sInterFeildRef[list[diffusionRunTime_.timeIndex()][step]];
    }
...
{    
    ...
    {
        diffWorkFieldInterFeildRef[list[diffusionRunTime_.timeIndex()][step]] 
      = S[list[diffusionRunTime_.timeIndex()][step]];
    }
